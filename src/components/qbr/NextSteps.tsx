...
export default function NextSteps() {
  ...
  return (
    <section id="next-steps" className="qbr-section section-alt px-6 py-16">
          ...
          {data.nextSteps.map((step, i) => (
            <div key={i} className="rounded-lg border bg-card overflow-hidden">
              <div className="flex items-center gap-3 border-b px-5 py-3">
                <span className="flex h-6 w-6 items-center justify-center rounded-md bg-primary text-xs font-medium text-primary-foreground">{i + 1}</span>
              ...
              <div className="grid gap-0 divide-y md:grid-cols-3 md:divide-x md:divide-y-0">
                <div className="px-5 py-4">
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">Outcome</p>
                  <p className="text-sm text-foreground">{step.outcome}</p>
                </div>
                <div className="px-5 py-4">
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">Initiative</p>
                  <p className="text-sm text-foreground">{step.initiative}</p>
                </div>
                <div className="px-5 py-4">
                  <p className="text-xs font-medium uppercase tracking-wider text-muted-foreground mb-1">Actions</p>
