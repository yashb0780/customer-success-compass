      ...
      <div className="mx-auto max-w-5xl space-y-10">
        <div>
          <div className="flex items-center gap-2 mb-1">
            ...
            <p className="text-xs font-medium uppercase tracking-[0.14em] text-subtle-foreground">Vision</p>
          </div>
            ...
            <div className="flex flex-col items-center gap-2 md:flex-row md:gap-0">
              {workflow.workflowSteps.map((step, i, arr) => (
                <div key={step} className="flex items-center gap-2">
                  <div className="min-w-[120px] rounded-pill border bg-card px-4 py-2.5 text-center text-xs font-medium text-foreground">
                    {step}
                  </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          {data.benefits.map((b, i) => (
            <div key={b.title} className="rounded-lg border bg-card p-6 space-y-3">
